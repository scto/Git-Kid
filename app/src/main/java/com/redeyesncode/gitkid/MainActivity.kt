...
class MainActivity : AppCompatActivity() {
    ...
    // MAJOR TASK IS TO REMOVE THE BOLIER PLATE CODE AND MANAGE WITHOUT USING SWTICH CASE OR IF ELSE STATEMENT.
    ...
    private fun setupMajorCommandsForGit() {
        ...
        binding.subCommandOne.onItemClickListener = OnItemClickListener{adapterView, view, position, id ->
            ...
            OnItemClickListener { adapterView, view, position, id ->
                when(id.toInt()){
                    ...
                    4->{
                        ...
                        val subCommands = resources.getStringArray(R.array.compare_two_commits_subcommands)
                        val arrayAdapter = ArrayAdapter(this@MainActivity,R.layout.dropdown_item_commands,subCommands)
                        binding.subCommandOne.setAdapter(arrayAdapter)
...
//        <!-- MORE GIT COMMANDS WILL BE  ADD IN NEXT COMMIT RELEASE. :) -->
        ...
        binding.btnSubmit.setOnClickListener {
            if (binding.autoCompleteMajorGitCommands.editableText.toString().equals("Major Git Commands")){
                ...
                if(subCommandPosition==0){
                    ...
                    binding.tvCommandUsage.text = "git tag -a v1.4 -m my version 1.4 and git push --tags"

                }else if(subCommandPosition==5){
                    binding.tvCommandUsage.text = "git tag -a v1.2 -m 'version 1.2' <commit-hash> and git push --tags"
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("cherry-pick")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("clone")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("commit")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("compare two commits")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("configure")){
                if(subCommandPosition==0){
                    binding.tvCommandUsage.text = "git config --global user.name username" +
                            "\n" +
                    ...
                    binding.tvCommandUsage.text = "git config --global user.signingkey <your-secret-gpg-key>"
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("debug")){
                if(subCommandPosition==0){
                    binding.tvCommandUsage.text = "git bisect start"

                }else if(subCommandPosition==1){
                    binding.tvCommandUsage.text = "git blame -L <number-line-start>,<number-line-end> <filename>"
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("delete/remove")){
                if(subCommandPosition==0){
                    binding.tvCommandUsage.text = "git branch -D <branch name>"

                }else if(subCommandPosition==1){
                    binding.tvCommandUsage.text = "git branch -D <branch name> <branch name> <branch name>"
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("ignore")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("initialize")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("merge")){
                if(subCommandPosition==0){
                    binding.tvCommandUsage.text = "git merge <branch-name>"

                }else if(subCommandPosition==1){
                    binding.tvCommandUsage.text = "git checkout <branch name> <path to file> --patch"

                }else{
                    showSelectCommandToast()
                }
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("modify")){
                if(subCommandPosition==0){
            ...
            }else if(binding.autoCompleteMajorGitCommands.editableText.toString().equals("rebase")){
                if(subCommandPosition==0){
